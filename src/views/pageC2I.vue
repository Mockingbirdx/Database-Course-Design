<template>
                ...
                <el-descriptions direction="vertical" :column="1">
                    <el-descriptions-item :span="2">
                        <el-space>
                            ...
                            <el-input-number v-model="form.threshold" :min="1" :max="10000000" />
    ...
    <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="mean" label="C2I平均值" width="120" />
        <el-table-column prop="std" label="标准差" width="120" />
        <el-table-column prop="PrbC2I9" label="PrbC2I9" width="120" />
...
const handleSubmit = async (formEl: FormInstance | undefined) => {
    ...
    axios({ method: 'GET', url: '/C2I/' + form.threshold })
        .then(resp => {
